...
Test the characters odt/html conversion tasks.
...
TEST_PATH = os.getcwd()
EXEC_PATH = 'yw7/'
DATA_PATH = 'data/' + OdtCharacters.SUFFIX + '/'

TEST_ODT = EXEC_PATH + 'yw7 Sample Project' + \
    OdtCharacters.SUFFIX + OdtCharacters.EXTENSION
...
class NrmOpr(unittest.TestCase):
    ...
    def test_html_to_yw7(self):
        ...
        documentFile = HtmlCharacters(TEST_HTML)
        converter = YwCnv()
    ...
    def test_yw7_to_odt(self):
        ...
        yw7File = Yw7File(TEST_YW7)
        documentFile = OdtCharacters(TEST_ODT)
        converter = YwCnv()
