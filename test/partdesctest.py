...
TEST_PATH = os.getcwd()
EXEC_PATH = 'yw7/'
DATA_PATH = 'data/partdesc/'

TEST_DOCUMENT = EXEC_PATH + 'yw7 Sample Project_partdesc.html'
...
class NrmOpr(unittest.TestCase):
    ...
    def test_yw7_to_partdesc(self):
        """Export yW7 chapters to html. """

        yw7File = Yw7File(TEST_YW7)
        documentFile = HtmlPartDesc(TEST_DOCUMENT)
        converter = Yw7Cnv()
