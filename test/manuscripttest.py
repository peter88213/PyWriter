...
Test the manuscript conversion tasks.
...
TEST_PATH = os.getcwd()
EXEC_PATH = 'yw7/'
DATA_PATH = 'data/manuscript/'

TEST_DOCUMENT = EXEC_PATH + 'yw7 Sample Project_manuscript.html'
...
class NrmOpr(unittest.TestCase):
    ...
    def test_yw7_to_manuscript(self):
    ...
    def test_manuscript_to_yw7(self):
