"""OdsBuilder - Class for OpenDocument xml file generation.
...
"""
from pywriter.odf.odf_builder import OdfBuilder


class OdsBuilder(OdfBuilder):
    """Build an ODS spreadsheet zipfile.
    """
