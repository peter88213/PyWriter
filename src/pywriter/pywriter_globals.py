...
MSG_UNSUPPORTED_TYPE = 'File type is not supported'
MSG_UNSUPPORTED_TARGET = 'Target is not of the supported type'
MSG_USER_CANCEL = 'Action canceled by user'
MSG_UNSUPPORTED_EXPORT = 'Export type is not supported'
